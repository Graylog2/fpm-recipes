...
DAEMON_ARGS="$GRAYLOG2_RADIO_JAVA_OPTS $DAEMON_LOG_OPTION -Djava.library.path=/usr/share/graylog2-radio/lib/sigar -jar $JAR_FILE radio -p $PIDFILE -f /etc/graylog2/radio/radio.conf $GRAYLOG2_RADIO_ARGS"
...
do_start()
{
	...
	if running ; then
		...
		start-stop-daemon --start --quiet --oknodo --pidfile $PIDFILE \
			...
			-c "exec $DAEMON $DAEMON_ARGS >> /var/log/graylog2-radio/console.log 2>&1"
		sleep 2
		if running ; then
			return 0
		else
